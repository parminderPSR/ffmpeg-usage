...
fn main() {
    ...
    println!("  Defaults: analyze EBU R128 via FFmpeg; write LOGS/ and a Markdown report; folders scanned recursively.");
    println!();
    println!("normalize");
    ...
    println!("  Single file without -o: <stem>_normalized.<ext> beside the input; directory -i: same per file (recursive)");
}
